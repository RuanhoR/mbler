export default {
  ...
  "build": {
    ...
    "subpack_folder_not_found": "{id} subpackage folder does not exist, packaging failed",
  ...
  "buildBase": {
    ...
    "invalid_project_config_format": "The project configuration file format is invalid",
