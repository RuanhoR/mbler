...
class Build extends baseBuild {
  ...
  async start() {
    ...
    logger.i('Build', [
      ...
      `${tip.build.tip_dist} ${process.env.MBLER_BUILD_MODULE}`
    ].join('\n'));
    ...
    await utils.sequentialPromiseAll([
      Promise.all([this.processMinification(data),
        // 资源包处理
    ...
    // 最终完成
    logger.i('Build', tip.build.build_success);
  }
